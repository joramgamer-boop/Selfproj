...
- [x] Withdrawals are recordable and always accepted into the Ledger
- [x] A withdrawal that touches the base, or occurs before the account has
      doubled, produces a prominent warning and a flag on the entry — never a
      block
- [x] Peak Balance is derived from the Ledger and always visible
- [x] Current Drawdown from Peak Balance is derived and always visible
- [x] Rule: at 20% Drawdown, creating a new Plan is blocked until a log review is
      acknowledged; the acknowledgement is a recorded event
- [x] The tripwire re-arms if Drawdown recovers and later falls back past 20%
- [x] Core tests cover Peak Balance across deposits, withdrawals and losing
